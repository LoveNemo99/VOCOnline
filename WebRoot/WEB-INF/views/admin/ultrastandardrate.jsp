...
<title>超标率报表</title>
	...
	$(function() {
		dataGrid = $('#dataGrid').datagrid({
			...
			columns : [ [ {
				...
				width : '120',
				title : '起始时间',
				field : 'creatDateTimeStart',
				sortable : true
			} , {
				width : '120',
				title : '结束时间',
				field : 'creatDateTimeEnd',
				sortable : true
			} , {
				width : '100',
				title : '超标率(%)',
		...
		$('#qy').combobox({
			url:'${ctx}/ultrastandardrate/pstree',
			valueField:'value',
			textField:'text',
			multiple:false,
			panelHeight:'auto',
			onSelect: function(rec){
				var ur = '${ctx}/ultrastandardrate/porttree?psCode='+rec.value;
	...
	function exp(){
		$('#searchForm').form({
			url : '${ctx}/ultrastandardrate/export',
			onSubmit : function() {
