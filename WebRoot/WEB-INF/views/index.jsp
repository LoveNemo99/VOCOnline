...
<script type="text/javascript">
	...
	$(function() {
		...
		$.post(layout_west_tree_url,function(data){
			var ii=0;
			$.each(data, function (i, e) {
				if(!e.pid){
					jQuery('#RightAccordion').accordion('add', {
                        title: e.text,
                        content: "<ul id='tree"+e.id+"' ></ul>",
                        selected: false,
                        iconCls:e.iconCls//e.Icon
                    });
                    jQuery('#RightAccordion div').css('overflow-y','hidden');//去除滚动条
					var datas = new Array();
					...
					jQuery('#tree'+e.id+' li').css('padding','2px');
				}
			});
			//alert(ii);
		},'json');
...
<body>
	...
	<div id="index_layout">
		...
		<div data-options="region:'west',split:true,hideCollapsedContent:false" title="主导航" style="width: 160px; overflow: hidden;overflow-y:auto;">
		...
		<div data-options="region:'center'" style="overflow: hidden;">
			<div id="index_tabs" style="overflow: hidden;">
				<div title="信息看板" data-options="border:false" style="overflow: hidden;">
					<iframe src="${ctx}/reportData/testpage" frameborder="0" style="border:0;width:100%;height:99.5%;"></iframe>
					
				</div>
			</div>
		</div>
		<div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 江苏天泽环保 版权所有 </div>
	</div>
