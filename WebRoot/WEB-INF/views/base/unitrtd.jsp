...
<title>报警类型管理</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前行计量单位？';
	var del_path = '${ctx}/measureRtdUnit/delete';
	var dataGrid_path = '${ctx}/measureRtdUnit/dataGrid';
	var addPage_path = '${ctx}/measureRtdUnit/addPage';
	var editPage_path = '${ctx}/measureRtdUnit/editPage?id=';
	var dataGrid;
	$(function() {
