...
<title>污染物因子</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前污染物因子？';
	var del_path = '${ctx}/pollutantfactor/delete';
	var dataGrid_path = '${ctx}/pollutantfactor/dataGrid';
	var addPage_path = '${ctx}/pollutantfactor/addPage';
	var editPage_path = '${ctx}/pollutantfactor/editPage?id=';
	var dataGrid;
	$(function() {
