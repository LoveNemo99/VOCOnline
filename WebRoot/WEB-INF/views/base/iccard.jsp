...
<title>ic卡开卡信息</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前ic卡？';
	var del_path = '${ctx}/iccard/delete';
	var dataGrid_path = '${ctx}/iccard/dataGrid';
	var addPage_path = '${ctx}/iccard/addPage';
	var editPage_path = '${ctx}/iccard/editPage?id=';
	var dataGrid;
	$(function() {
