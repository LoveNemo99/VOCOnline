...
<title>计量单位管理</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前计量单位？';
	var del_path = '${ctx}/measureUnit/delete';
	var dataGrid_path = '${ctx}/measureUnit/dataGrid';
	var addPage_path = '${ctx}/measureUnit/addPage';
	var editPage_path = '${ctx}/measureUnit/editPage?id=';
	var dataGrid;
	$(function() {
