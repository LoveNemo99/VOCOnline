...
<title>报表展示</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前列的信息？';
	var del_path = '${ctx}/columnsReport/delete';
	var dataGrid_path = '${ctx}/columnsReport/dataGridGas';
	var addPage_path = '${ctx}/columnsReport/addgasPage';
	var editPage_path = '${ctx}/columnsReport/editgasPage?id=';
	var dataGrid;
	$(function() {
