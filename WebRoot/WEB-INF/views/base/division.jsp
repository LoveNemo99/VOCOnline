...
<title>报警类型管理</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前行政区划？';
	var del_path = '${ctx}/division/delete';
	var dataGrid_path = '${ctx}/division/dataGrid';
	var addPage_path = '${ctx}/division/addPage';
	var editPage_path = '${ctx}/division/editPage?id=';
	var dataGrid;
	$(function() {
