...
<title>企业许可证</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前企业许可证？';
	var del_path = '${ctx}/licenceinfo/delete';
	var dataGrid_path = '${ctx}/licenceinfo/dataGrid';
	var addPage_path = '${ctx}/licenceinfo/addPage';
	var editPage_path = '${ctx}/licenceinfo/editPage?id=';
	var factorPage_path = '${ctx}/licenceinfo/factorPage?id=';
	var dataGrid;
	$(function() {
