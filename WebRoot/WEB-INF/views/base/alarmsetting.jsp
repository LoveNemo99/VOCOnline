...
<title>报警设置</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前报警设置？';
	var del_path = '${ctx}/alarmsetting/delete';
	var dataGrid_path = '${ctx}/alarmsetting/dataGrid';
	var addPage_path = '${ctx}/alarmsetting/addPage';
	var editPage_path = '${ctx}/alarmsetting/editPage?id=';
	var dataGrid;
	$(function() {
		dataGrid = $('#dataGrid').datagrid({
			...
			columns : [ [ {
				...
				width : '100',
				title : '浓度预警值',
				field : 'concentrationEarlyWarningValue',
				sortable : true
			} , {
				width : '100',
				title : '浓度限制值',
				field : 'concentrationLimitValue',
				sortable : true
			} , {
				width : '100',
				title : '排污量预警值',
				field : 'piEarlyWarningValue',
				sortable : true
			} , {
				width : '200',
				title : '排污量限制值',
