...
<title>报警联系人管理</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前报警联系人？';
	var del_path = '${ctx}/alarmcontact/delete';
	var dataGrid_path = '${ctx}/alarmcontact/dataGrid';
	var addPage_path = '${ctx}/alarmcontact/addPage';
	var editPage_path = '${ctx}/alarmcontact/editPage?id=';
	var dataGrid;
	$(function() {
