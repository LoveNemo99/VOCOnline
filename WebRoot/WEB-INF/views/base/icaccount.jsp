...
<title>ic卡账户信息</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前ic卡账户？';
	var del_path = '${ctx}/icaccount/delete';
	var dataGrid_path = '${ctx}/icaccount/dataGrid';
	var addPage_path = '${ctx}/icaccount/addPage';
	var editPage_path = '${ctx}/icaccount/editPage?id=';
	var dataGrid;
	$(function() {
