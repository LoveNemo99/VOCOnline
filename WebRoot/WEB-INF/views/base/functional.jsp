...
<title>报警类型管理</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前功能区？';
	var del_path = '${ctx}/functional/delete';
	var dataGrid_path = '${ctx}/functional/dataGrid';
	var addPage_path = '${ctx}/functional/addPage';
	var editPage_path = '${ctx}/functional/editPage?id=';
	var dataGrid;
	$(function() {
