...
<title>报警方式管理</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前报警方式？';
	var del_path = '${ctx}/alarmmode/delete';
	var dataGrid_path = '${ctx}/alarmmode/dataGrid';
	var addPage_path = '${ctx}/alarmmode/addPage';
	var editPage_path = '${ctx}/alarmmode/editPage?id=';
	var dataGrid;
	$(function() {
