...
<title>报警类型管理</title>
	<script type="text/javascript">
	var del_question = '您是否要删除当前报警类型？';
	var del_path = '${ctx}/alarmtype/delete';
	var dataGrid_path = '${ctx}/alarmtype/dataGrid';
	var addPage_path = '${ctx}/alarmtype/addPage';
	var editPage_path = '${ctx}/alarmtype/editPage?id=';
	var dataGrid;
	$(function() {
