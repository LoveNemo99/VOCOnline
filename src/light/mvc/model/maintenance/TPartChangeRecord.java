...
public class TPartChangeRecord implements Serializable {
	...
	public TPartChangeRecord() {
		super();
	}

	public TPartChangeRecord(int id, String partName, Date time, String company,
