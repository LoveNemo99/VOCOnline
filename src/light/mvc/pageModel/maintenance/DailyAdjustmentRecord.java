...
public class DailyAdjustmentRecord implements Serializable {
	...
	public DailyAdjustmentRecord() {
		super();
	}

	public DailyAdjustmentRecord(int id, Date time, String pollutionSourceName,
