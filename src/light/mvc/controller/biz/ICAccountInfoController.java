...
@Controller
@RequestMapping("/icaccount")
public class ICAccountInfoController extends BaseController {

	@Autowired
	private ICAccountInfoServiceI pService;
	
	@RequestMapping("/manager")
	public String manager() {
		return "/base/icaccount";
	}
...
//	}
	...
	@ResponseBody
	public Grid dataGrid(ICAccountInfo record, PageFilter ph) {
		Grid grid = new Grid();
