...
@Controller
@RequestMapping("/alarmmode")
public class AlarmModeController extends BaseController {

	@Autowired
	private AlarmModeServiceI pService;
	
	@RequestMapping("/manager")
	public String manager() {
		return "/base/alarmmode";
	}
	...
	@ResponseBody
	public Grid dataGrid(AlarmMode record, PageFilter ph) {
		Grid grid = new Grid();
