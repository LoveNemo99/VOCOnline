...
public class ScMeasureUnitController extends BaseController {

	@Autowired
	private MeasureUnitServiceI pService;
	...
	@RequestMapping("/tree")
	@ResponseBody
	public List<Tree> unitTree(ScMeasureUnit demo, PageFilter ph) {
	...
	@RequestMapping("/add")
	@ResponseBody
	public Json add(ScMeasureUnit demo) {
		Json j = new Json();
		try {
			pService.add(demo);
			j.setSuccess(true);
	...
	public String editPage(HttpServletRequest request, Integer id) {
		ScMeasureUnit r = pService.get(id);
		request.setAttribute("pageObj", r);
		return "/base/unitEdit";
	}

	@RequestMapping("/edit")
	@ResponseBody
	public Json edit(ScMeasureUnit demo) {
		Json j = new Json();
		try {
			pService.edit(demo);
			j.setSuccess(true);
	...
	@ResponseBody
	public Grid dataGrid(ScMeasureUnit record, PageFilter ph) {
		Grid grid = new Grid();
